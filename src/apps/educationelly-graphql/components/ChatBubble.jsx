...
export default function ChatBubble({ initialMessages = [] }) {
  ...
  const handleSend = async (e) => {
    ...
    const aiMessage = {
      id: Date.now() + 1,
      role: 'assistant',
      content: 'This is a simulated GraphQL mutation response from the educationELLy-GraphQL AI backend. In production, this uses a CHAT_MUTATION to communicate with the AI service.',
      timestamp: new Date().toISOString(),
      backend: 'openai',
      model: 'gpt-4',
    };
  ...
  return (
    <>
      ...
      {isOpen && (
        <ChatWindowContainer>
          <ChatHeader>
            <span>educationELLy-GraphQL AI</span>
            <button
          ...
          <MessagesContainer>
            {messages.length === 0 ? (
              <EmptyState>
                ...
                <p>Hi! I'm your GraphQL-powered AI assistant for ELL program management.</p>
              </EmptyState>
            ) : (
              messages.map(msg => (
